...
combine nil l = l
combine l nil = l
combine (h1::t1) (h2::t2) = ite (member h1 (h2::t2))
                            (combine t1 (h2::t2))
                            (h1::combine t1 (h2::t2))
...
list_difference nil (h::t) = nil
list_difference (h1::t1) (h2::t2) = ite (member h1 (h2::t2))
                                    (list_difference t1 (h2::t2))
                                    (h1::(list_difference t1 (h2::t2)))
-- Return the set difference, s1 minus s2
--set_difference: (eq a) => (s1: set a) -> (s2: set a) -> set a
...
--pairrelt takes an elt h and a list b and returns a list of all
